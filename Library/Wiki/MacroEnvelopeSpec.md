...
Documents and verifies macro-scale cosmological fluid envelopes (`MacroCosmicEnvelope`), Primorial 210 total mass budget conservation ($27 \text{ Baryon} + 55 \text{ Dark} + 128 \text{ H}_2\text{O} = 210$), star formation Jeans mass thresholds, and metrically bounded coarse-graining using QuickCheck property testing and compile-time proof witnesses.

---

## 1. Mathematical Foundation & Cosmological Invariants

Layer 9 `Idris2-Cosmology` models macro cosmological fluid dynamics:
